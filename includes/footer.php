...
<h3>Astleys Shop</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> We sell stuff.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
                ...
                <div class="media-body">
                    <p>Bell Street, Dundee, Scotland</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(044) 12345678<br>(044) 12345677</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">hacklab@uadhacklab.com</a></span>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="../affix.php?type=terms.php">T&Cs</a></span>
                </div>
            </li>
