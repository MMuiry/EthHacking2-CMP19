...
$emailaddress=md5($_POST['emailaddress']);
...
<button type="button" class="btn-upper btn btn-primary checkout-page-button" data-toggle="modal" data-target="#myModal">Update image</button>
...
<form class="register-form" role="form" method="post" name="chngpwd" onSubmit="return valid();">
					...
					<input type="text" class="form-control unicase-form-control text-input" value ="<?php echo $row['email'];?>" id="emailaddress" name="emailaddress" readonly>
					</div>
         ...
         <div class="modal fade" id="myModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="changepicture.php" id="form" enctype="multipart/form-data" role="form" method="POST">
